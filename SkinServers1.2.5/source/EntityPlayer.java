...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public EntityPlayer(Minecraft par1Minecraft, World par2World) {
    	this(par2World);
    ...
    public void updateCloak()
    {
		...
		playerCloakUrl = (new StringBuilder()).append(capeServerURL).append(username.toLowerCase()).append(ulrAppendix).toString();

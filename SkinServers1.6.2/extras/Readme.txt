SkinServers v162.0 for minecraft 1.6.2
...
3) Copy the directory named 1.6.2 and paste as 1.6.2SS(you may name however you please, but everything must match) so there are now two copies.
...
to
"id": "1.6.2SS",
6) Create or edit profile in the launcher and make sure the version it uses is 1.6.2SS
